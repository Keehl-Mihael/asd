...
template<class K, class E>
void HashTable<K,E>::create(int the_divisor){
	  divisor = the_divisor;
	  dsize = 0;
...
template<class K, class E>
bool HashTable<K,E>::lookfor(const E &e) const {
    int i = (int) hashm(e) % divisor;   // the home bucket
    int j = i;
    do {
